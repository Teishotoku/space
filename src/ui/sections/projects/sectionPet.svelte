<script lang="ts">
	...
	import Solidjs from 'img/logo/solidjs.png';
	import Tailwind from 'img/logo/tailwind.svg';
	import Typescript from 'img/logo/typescript.svg';
</script>
...
<section>
	...
	<div class="pet">
		<div class="dark">
			<div class="left">
				<h1>Best Shop</h1>
				<PrimaryButton txt="on site" cls="btnPet1" href="https://pet1.teisho.space" />
			</div>
			<div class="right">
				<div class="stack">
					<h2>stack</h2>
